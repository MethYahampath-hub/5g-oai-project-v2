...
static asn_per_constraints_t asn_PER_type_LTE_later_constr_6 CC_NOTUSED = {
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_criticalExtensionsFuture_specs_8 = {
	sizeof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later__criticalExtensionsFuture),
	offsetof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_LTE_later_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later, choice.rrcConnectionReestablishmentRequest_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_RRCConnectionReestablishmentRequest_5GC_NB_r16_IEs,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_LTE_later_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionReestablishmentRequest-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture */
};
static asn_CHOICE_specifics_t asn_SPC_LTE_later_specs_6 = {
	sizeof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later),
	offsetof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later, _asn_ctx),
	offsetof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later, present),
	sizeof(((struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later__later *)0)->present),
	asn_MAP_LTE_later_tag2el_6,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_later_6 = {
	"later",
	"later",
	&asn_OP_CHOICE,
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_LTE_later_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_LTE_later_6,
	2,	/* Elements count */
	&asn_SPC_LTE_later_specs_6	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_LTE_later_4[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionReestablishmentRequest_NB__criticalExtensions__later, choice.later),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_LTE_later_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_LTE_later_4,
