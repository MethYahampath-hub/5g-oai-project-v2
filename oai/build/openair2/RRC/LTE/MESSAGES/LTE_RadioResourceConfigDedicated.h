...
typedef enum LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup_PR {
	...
	LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup_PR_crs_IntfMitigEnabled,
	LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup_PR_crs_IntfMitigNumPRBs
} LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup_PR;
typedef enum LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup__crs_IntfMitigNumPRBs {
	LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup__crs_IntfMitigNumPRBs_n6	= 0,
	LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup__crs_IntfMitigNumPRBs_n24	= 1
} e_LTE_RadioResourceConfigDedicated__ext7__crs_IntfMitigConfig_r15__setup__crs_IntfMitigNumPRBs;
...
struct LTE_RLF_TimersAndConstantsMCG_Failure_r16;
struct LTE_SetupRelease_CRS_ChEstMPDCCH_ConfigDedicated_r16;
...
typedef struct LTE_RadioResourceConfigDedicated {
	...
	struct LTE_RadioResourceConfigDedicated__ext9 {
		struct LTE_RLF_TimersAndConstantsMCG_Failure_r16	*rlf_TimersAndConstantsMCG_Failure_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_CRS_ChEstMPDCCH_ConfigDedicated_r16	*crs_ChEstMPDCCH_ConfigDedicated_r16;	/* OPTIONAL */
		LTE_C_RNTI_t	*newUE_Identity_r16;	/* OPTIONAL */
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_crs_IntfMitigNumPRBs_32;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LTE_RadioResourceConfigDedicated_1[15];
