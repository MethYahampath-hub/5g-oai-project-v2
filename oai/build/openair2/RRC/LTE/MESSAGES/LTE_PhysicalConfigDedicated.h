...
typedef enum LTE_PhysicalConfigDedicated__ext13__ce_CSI_RS_Feedback_r16 {
	LTE_PhysicalConfigDedicated__ext13__ce_CSI_RS_Feedback_r16_enabled	= 0
} e_LTE_PhysicalConfigDedicated__ext13__ce_CSI_RS_Feedback_r16;
...
struct LTE_PDSCH_ConfigDedicated_v1610;
struct LTE_PUSCH_ConfigDedicated_v1610;
struct LTE_SetupRelease_ResourceReservationConfigDedicatedDL_r16;
struct LTE_SetupRelease_ResourceReservationConfigDedicatedUL_r16;
struct LTE_SetupRelease_SoundingRS_UL_ConfigDedicatedAdd_r16;
struct LTE_SetupRelease_UplinkPowerControlAddSRS_r16;
struct LTE_SetupRelease_SoundingRS_VirtualCellID_r16;
struct LTE_SetupRelease_WidebandPRG_r16;
...
typedef struct LTE_PhysicalConfigDedicated {
	...
	struct LTE_PhysicalConfigDedicated__ext13 {
		struct LTE_PDSCH_ConfigDedicated_v1610	*pdsch_ConfigDedicated_v1610;	/* OPTIONAL */
		struct LTE_PUSCH_ConfigDedicated_v1610	*pusch_ConfigDedicated_v1610;	/* OPTIONAL */
		long	*ce_CSI_RS_Feedback_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_ResourceReservationConfigDedicatedDL_r16	*resourceReservationConfigDedicatedDL_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_ResourceReservationConfigDedicatedUL_r16	*resourceReservationConfigDedicatedUL_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_SoundingRS_UL_ConfigDedicatedAdd_r16	*soundingRS_UL_ConfigDedicatedAdd_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_UplinkPowerControlAddSRS_r16	*uplinkPowerControlAddSRS_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_SoundingRS_VirtualCellID_r16	*soundingRS_VirtualCellID_r16;	/* OPTIONAL */
		struct LTE_SetupRelease_WidebandPRG_r16	*widebandPRG_r16;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_ce_CSI_RS_Feedback_r16_163;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LTE_PhysicalConfigDedicated_1[23];
...
#include "LTE_PDSCH-ConfigDedicated-v1610.h"
#include "LTE_PUSCH-ConfigDedicated-v1610.h"
