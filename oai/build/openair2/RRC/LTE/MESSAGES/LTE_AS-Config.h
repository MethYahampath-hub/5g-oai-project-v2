...
struct LTE_AS_ConfigNR_v1570;
struct LTE_AS_ConfigNR_v1620;
...
typedef struct LTE_AS_Config {
	...
	struct LTE_AS_Config__ext6 {
		struct LTE_AS_ConfigNR_v1570	*as_ConfigNR_v1570;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext6;
	struct LTE_AS_Config__ext7 {
		struct LTE_AS_ConfigNR_v1620	*as_ConfigNR_v1620;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_LTE_AS_Config_1[16];
