...
typedef struct LTE_LogMeasInfo_r10 {
	...
	struct LTE_LogMeasInfo_r10__ext7 {
		struct LTE_MeasResultCellListNR_r15	*measResultListNR_r16;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext7;
	struct LTE_LogMeasInfo_r10__ext8 {
		struct LTE_LogMeasInfo_r10__ext8__measResultListNR_v1640 {
...
extern asn_TYPE_member_t asn_MBR_LTE_LogMeasInfo_r10_1[13];
