...
typedef enum LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15_PR {
	LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15_PR_NOTHING,	/* No components present */
	LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15_PR_release,
	LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15_PR_setup
} LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15_PR;
typedef enum LTE_LogicalChannelConfig__ext5__bitRateMultiplier_r16 {
	LTE_LogicalChannelConfig__ext5__bitRateMultiplier_r16_x40	= 0,
	LTE_LogicalChannelConfig__ext5__bitRateMultiplier_r16_x70	= 1,
	LTE_LogicalChannelConfig__ext5__bitRateMultiplier_r16_x100	= 2,
	LTE_LogicalChannelConfig__ext5__bitRateMultiplier_r16_x200	= 3
} e_LTE_LogicalChannelConfig__ext5__bitRateMultiplier_r16;
...
typedef struct LTE_LogicalChannelConfig {
	...
	struct LTE_LogicalChannelConfig__ext4 {
		...
		struct LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15 {
			LTE_LogicalChannelConfig__ext4__channelAccessPriority_r15_PR present;
			union LTE_LogicalChannelConfig__LTE_ext4__LTE_channelAccessPriority_r15_u {
				NULL_t	 release;
				long	 setup;
			} choice;
	...
	struct LTE_LogicalChannelConfig__ext5 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_bitRateMultiplier_r16_64;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LTE_LogicalChannelConfig_1[6];
