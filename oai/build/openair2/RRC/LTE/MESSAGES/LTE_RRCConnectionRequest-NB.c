...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_criticalExtensionsFuture_specs_6 = {
	sizeof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later__criticalExtensionsFuture),
	offsetof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_LTE_later_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later, choice.rrcConnectionRequest_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_RRCConnectionRequest_5GC_NB_r16_IEs,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
		...
		"rrcConnectionRequest-r16"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_LTE_later_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionRequest-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* criticalExtensionsFuture */
};
static asn_CHOICE_specifics_t asn_SPC_LTE_later_specs_4 = {
	sizeof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later),
	offsetof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later, _asn_ctx),
	offsetof(struct LTE_RRCConnectionRequest_NB__criticalExtensions__later, present),
	sizeof(((struct LTE_RRCConnectionRequest_NB__criticalExtensions__later *)0)->present),
...
static asn_TYPE_member_t asn_MBR_LTE_criticalExtensions_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_RRCConnectionRequest_NB__criticalExtensions, choice.later),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
