...
typedef enum LTE_ReportConfigInterRAT__ext8__useAutonomousGapsNR_r16 {
	LTE_ReportConfigInterRAT__ext8__useAutonomousGapsNR_r16_setup	= 0
} e_LTE_ReportConfigInterRAT__ext8__useAutonomousGapsNR_r16;
...
typedef struct LTE_ReportConfigInterRAT {
	...
	struct LTE_ReportConfigInterRAT__ext8 {
		long	*useAutonomousGapsNR_r16;	/* OPTIONAL */
		struct LTE_MeasRSSI_ReportConfig_r13	*measRSSI_ReportConfigNR_r16;	/* OPTIONAL */
...
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_useAutonomousGapsNR_r16_75;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LTE_ReportConfigInterRAT_1[12];
