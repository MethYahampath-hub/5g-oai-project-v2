...
struct LTE_InterFreqCarrierFreqList_v1610;
struct LTE_InterFreqCarrierFreqListExt_v1610;
struct LTE_MeasIdleConfigSIB_NR_r16;
...
typedef struct LTE_SystemInformationBlockType5 {
	...
	struct LTE_SystemInformationBlockType5__ext8 {
		struct LTE_InterFreqCarrierFreqList_v1610	*interFreqCarrierFreqList_v1610;	/* OPTIONAL */
		struct LTE_InterFreqCarrierFreqListExt_v1610	*interFreqCarrierFreqListExt_v1610;	/* OPTIONAL */
		struct LTE_MeasIdleConfigSIB_NR_r16	*measIdleConfigSIB_NR_r16;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType5_1[10];
