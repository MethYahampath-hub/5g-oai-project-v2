...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_NR_daps_SourceRelease_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
asn_TYPE_member_t asn_MBR_NR_RRCReconfiguration_v1610_IEs_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_NR_dedicatedPosSysInfoDelivery_r16_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_NR_dedicatedPosSysInfoDelivery_r16_constraint_1
		},
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_RRCReconfiguration_v1610_IEs, nonCriticalExtension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_RRCReconfiguration_v1700_IEs,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
