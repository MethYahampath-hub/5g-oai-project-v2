...
struct NR_CO_DurationsPerCell_r17;
...
typedef struct NR_SlotFormatIndicator {
	...
	struct NR_SlotFormatIndicator__ext2 {
		struct NR_SlotFormatIndicator__ext2__switchTriggerToAddModListSizeExt_r16 {
			A_SEQUENCE_OF(struct NR_SearchSpaceSwitchTrigger_r16) list;
			
			/* Context for parsing across buffer boundaries */
			asn_struct_ctx_t _asn_ctx;
		} *switchTriggerToAddModListSizeExt_r16;
		struct NR_SlotFormatIndicator__ext2__switchTriggerToReleaseListSizeExt_r16 {
			A_SEQUENCE_OF(NR_ServCellIndex_t) list;
	...
	struct NR_SlotFormatIndicator__ext3 {
		struct NR_SlotFormatIndicator__ext3__co_DurationsPerCellToAddModList_r17 {
			A_SEQUENCE_OF(struct NR_CO_DurationsPerCell_r17) list;
...
extern asn_TYPE_member_t asn_MBR_NR_SlotFormatIndicator_1[7];
