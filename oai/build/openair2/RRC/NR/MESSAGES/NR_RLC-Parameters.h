...
typedef enum NR_RLC_Parameters__ext2__am_WithLongSN_RedCap_r17 {
	NR_RLC_Parameters__ext2__am_WithLongSN_RedCap_r17_supported	= 0
} e_NR_RLC_Parameters__ext2__am_WithLongSN_RedCap_r17;
...
typedef struct NR_RLC_Parameters {
	...
	struct NR_RLC_Parameters__ext2 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_NR_am_WithLongSN_RedCap_r17_15;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_NR_RLC_Parameters;
extern asn_SEQUENCE_specifics_t asn_SPC_NR_RLC_Parameters_specs_1;
extern asn_TYPE_member_t asn_MBR_NR_RLC_Parameters_1[5];
