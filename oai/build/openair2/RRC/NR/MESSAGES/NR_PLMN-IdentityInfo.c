 ...
 */
static int
memb_NR_trackingAreaList_r17_constraint_14(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_NR_gNB_ID_Length_r17_constraint_14(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_NR_trackingAreaList_r17_constr_15 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  12 }	/* (SIZE(1..12)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_NR_trackingAreaList_r17_constr_15 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 4,  4,  1,  12 }	/* (SIZE(1..12)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_memb_NR_gNB_ID_Length_r17_constr_17 CC_NOTUSED = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_NR_plmn_IdentityList_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_NR_cellReservedForOperatorUse_constr_7,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_NR_iab_Support_r16_constr_12,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_NR_trackingAreaList_r17_15[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_NR_trackingAreaList_r17_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_NR_trackingAreaList_r17_specs_15 = {
	sizeof(struct NR_PLMN_IdentityInfo__ext2__trackingAreaList_r17),
	offsetof(struct NR_PLMN_IdentityInfo__ext2__trackingAreaList_r17, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_NR_trackingAreaList_r17_15 = {
	"trackingAreaList-r17",
	"trackingAreaList-r17",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_NR_trackingAreaList_r17_tags_15,
	sizeof(asn_DEF_NR_trackingAreaList_r17_tags_15)
		/sizeof(asn_DEF_NR_trackingAreaList_r17_tags_15[0]) - 1, /* 1 */
	asn_DEF_NR_trackingAreaList_r17_tags_15,	/* Same as above */
	sizeof(asn_DEF_NR_trackingAreaList_r17_tags_15)
		/sizeof(asn_DEF_NR_trackingAreaList_r17_tags_15[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_NR_trackingAreaList_r17_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		SEQUENCE_OF_constraint
	},
	asn_MBR_NR_trackingAreaList_r17_15,
	1,	/* Single element */
	&asn_SPC_NR_trackingAreaList_r17_specs_15	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_NR_ext2_14[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_PLMN_IdentityInfo__ext2, trackingAreaList_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_NR_trackingAreaList_r17_15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_NR_trackingAreaList_r17_constr_15,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_NR_trackingAreaList_r17_constraint_14
		},
		0, 0, /* No default value */
		"trackingAreaList-r17"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_PLMN_IdentityInfo__ext2, gNB_ID_Length_r17),
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_NR_gNB_ID_Length_r17_constr_17,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_NR_gNB_ID_Length_r17_constraint_14
		},
		0, 0, /* No default value */
		"gNB-ID-Length-r17"
		},
...
static const asn_TYPE_tag2member_t asn_MAP_NR_ext2_tag2el_14[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* gNB-ID-Length-r17 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NR_ext2_specs_14 = {
	sizeof(struct NR_PLMN_IdentityInfo__ext2),
	offsetof(struct NR_PLMN_IdentityInfo__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NR_PLMN_IdentityInfo_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_NR_plmn_IdentityList_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
			memb_NR_plmn_IdentityList_constraint_1
		},
		0, 0, /* No default value */
		"plmn-IdentityList"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct NR_PLMN_IdentityInfo, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_NR_ext1_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_PLMN_IdentityInfo, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_NR_ext2_14,
		0,
...
static const int asn_MAP_NR_PLMN_IdentityInfo_oms_1[] = { 1, 2, 5, 6 };
