...
static asn_TYPE_member_t asn_MBR_NR_ext2_10[] = {
	{ ATF_POINTER, 3, offsetof(struct NR_SSB_ConfigMobility__ext2, deriveSSB_IndexFromCellInter_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct NR_SSB_ConfigMobility__ext2, ssb_PositionQCL_Common_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_SSB_ConfigMobility__ext2, ssb_PositionQCL_Cells_r17),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_NR_SetupRelease_SSB_PositionQCL_CellList_r17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_NR_ext2_oms_10[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_NR_ext2_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_ext2_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* deriveSSB-IndexFromCellInter-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ssb-PositionQCL-Common-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ssb-PositionQCL-Cells-r17 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NR_ext2_specs_10 = {
	sizeof(struct NR_SSB_ConfigMobility__ext2),
	offsetof(struct NR_SSB_ConfigMobility__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_NR_ext3_14[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_SSB_ConfigMobility__ext3, cca_CellsToAddModList_r17),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_PCI_List,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_SSB_ConfigMobility__ext3, cca_CellsToRemoveList_r17),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_PCI_List,
		0,
...
static const int asn_MAP_NR_ext3_oms_14[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_NR_ext3_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_ext3_tag2el_14[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cca-CellsToAddModList-r17 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cca-CellsToRemoveList-r17 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NR_ext3_specs_14 = {
	sizeof(struct NR_SSB_ConfigMobility__ext3),
	offsetof(struct NR_SSB_ConfigMobility__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NR_SSB_ConfigMobility_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct NR_SSB_ConfigMobility, ss_RSSI_Measurement),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct NR_SSB_ConfigMobility, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_NR_ext1_6,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct NR_SSB_ConfigMobility, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_NR_ext2_10,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_SSB_ConfigMobility, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_NR_ext3_14,
		0,
...
static const int asn_MAP_NR_SSB_ConfigMobility_oms_1[] = { 0, 2, 3, 4, 5 };
