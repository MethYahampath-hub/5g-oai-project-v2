...
typedef enum NR_PDCP_Parameters__ext2__longSN_RedCap_r17 {
	NR_PDCP_Parameters__ext2__longSN_RedCap_r17_supported	= 0
} e_NR_PDCP_Parameters__ext2__longSN_RedCap_r17;
typedef enum NR_PDCP_Parameters__ext2__udc_r17__standardDictionary_r17 {
	NR_PDCP_Parameters__ext2__udc_r17__standardDictionary_r17_supported	= 0
} e_NR_PDCP_Parameters__ext2__udc_r17__standardDictionary_r17;
typedef enum NR_PDCP_Parameters__ext2__udc_r17__continueUDC_r17 {
	NR_PDCP_Parameters__ext2__udc_r17__continueUDC_r17_supported	= 0
} e_NR_PDCP_Parameters__ext2__udc_r17__continueUDC_r17;
typedef enum NR_PDCP_Parameters__ext2__udc_r17__supportOfBufferSize_r17 {
	NR_PDCP_Parameters__ext2__udc_r17__supportOfBufferSize_r17_kbyte4	= 0,
	NR_PDCP_Parameters__ext2__udc_r17__supportOfBufferSize_r17_kbyte8	= 1
} e_NR_PDCP_Parameters__ext2__udc_r17__supportOfBufferSize_r17;
...
typedef struct NR_PDCP_Parameters {
	...
	struct NR_PDCP_Parameters__ext2 {
		long	*longSN_RedCap_r17;	/* OPTIONAL */
		struct NR_PDCP_Parameters__ext2__udc_r17 {
			long	*standardDictionary_r17;	/* OPTIONAL */
			struct NR_PDCP_Parameters__ext2__udc_r17__operatorDictionary_r17 {
				long	 versionOfDictionary_r17;
				NR_PLMN_Identity_t	 associatedPLMN_ID_r17;
...
/* extern asn_TYPE_descriptor_t asn_DEF_NR_longSN_RedCap_r17_76;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_standardDictionary_r17_79;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_continueUDC_r17_84;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_supportOfBufferSize_r17_86;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_NR_PDCP_Parameters_1[10];
