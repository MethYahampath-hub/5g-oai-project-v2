...
typedef enum NR_EventTriggerConfig__eventId_PR {
	...
	NR_EventTriggerConfig__eventId_PR_ext1
...
typedef enum NR_EventTriggerConfig__ext2__coarseLocationRequest_r17 {
	NR_EventTriggerConfig__ext2__coarseLocationRequest_r17_true	= 0
} e_NR_EventTriggerConfig__ext2__coarseLocationRequest_r17;
...
typedef struct NR_EventTriggerConfig {
	struct NR_EventTriggerConfig__eventId {
		...
		union NR_EventTriggerConfig__NR_eventId_u {
			 ...
			 */
			struct NR_EventTriggerConfig__eventId__ext1 {
				struct NR_EventTriggerConfig__eventId__ext1__eventX1_r17 {
					NR_SL_MeasTriggerQuantity_r16_t	 x1_Threshold1_Relay_r17;
					NR_MeasTriggerQuantity_t	 x1_Threshold2_r17;
				...
				struct NR_EventTriggerConfig__eventId__ext1__eventX2_r17 {
					NR_SL_MeasTriggerQuantity_r16_t	 x2_Threshold_Relay_r17;
					BOOLEAN_t	 reportOnLeave_r17;
					NR_Hysteresis_t	 hysteresis_r17;
					NR_TimeToTrigger_t	 timeToTrigger_r17;
				...
				struct NR_EventTriggerConfig__eventId__ext1__eventD1_r17 {
	...
	struct NR_EventTriggerConfig__ext2 {
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_reportAmount_62;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_reportAddNeighMeas_76;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_includeCommonLocationInfo_r16_82;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_NR_coarseLocationRequest_r17_88;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_NR_EventTriggerConfig_1[12];
