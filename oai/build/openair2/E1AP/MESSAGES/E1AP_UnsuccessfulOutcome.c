...
select_UnsuccessfulOutcome_E1AP_criticality_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	...
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct E1AP_UnsuccessfulOutcome, procedureCode));
...
static asn_type_selector_result_t
select_UnsuccessfulOutcome_E1AP_value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_E1AP_E1AP_ELEMENTARY_PROCEDURES_1;
	size_t constraining_column = 3; /* &procedureCode */
...
static asn_TYPE_member_t asn_MBR_E1AP_value_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.GNB_CU_UP_E1SetupFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_GNB_CU_UP_E1SetupFailure,
		0,
		{
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.GNB_CU_CP_E1SetupFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_GNB_CU_CP_E1SetupFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.GNB_CU_UP_ConfigurationUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_GNB_CU_UP_ConfigurationUpdateFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.GNB_CU_CP_ConfigurationUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_GNB_CU_CP_ConfigurationUpdateFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.BearerContextSetupFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_BearerContextSetupFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.BearerContextModificationFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_BearerContextModificationFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.ResourceStatusFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_ResourceStatusFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome__value, choice.IAB_UPTNLAddressUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_E1AP_IAB_UPTNLAddressUpdateFailure,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const asn_TYPE_tag2member_t asn_MAP_E1AP_value_tag2el_4[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 7 }, /* GNB-CU-UP-E1SetupFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 6 }, /* GNB-CU-CP-E1SetupFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 5 }, /* GNB-CU-UP-ConfigurationUpdateFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 4 }, /* GNB-CU-CP-ConfigurationUpdateFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 3 }, /* BearerContextSetupFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 2 }, /* BearerContextModificationFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 1 }, /* ResourceStatusFailure */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 0 } /* IAB-UPTNLAddressUpdateFailure */
};
static asn_CHOICE_specifics_t asn_SPC_E1AP_value_specs_4 = {
	sizeof(struct E1AP_UnsuccessfulOutcome__value),
	offsetof(struct E1AP_UnsuccessfulOutcome__value, _asn_ctx),
	offsetof(struct E1AP_UnsuccessfulOutcome__value, present),
	sizeof(((struct E1AP_UnsuccessfulOutcome__value *)0)->present),
...
asn_TYPE_member_t asn_MBR_E1AP_UnsuccessfulOutcome_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome, procedureCode),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome, criticality),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_E1AP_Criticality,
		select_UnsuccessfulOutcome_E1AP_criticality_type,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct E1AP_UnsuccessfulOutcome, value),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_E1AP_value_4,
		select_UnsuccessfulOutcome_E1AP_value_type,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
...
static const ber_tlv_tag_t asn_DEF_E1AP_UnsuccessfulOutcome_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_E1AP_UnsuccessfulOutcome_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* procedureCode */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* criticality */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* value */
};
asn_SEQUENCE_specifics_t asn_SPC_E1AP_UnsuccessfulOutcome_specs_1 = {
	sizeof(struct E1AP_UnsuccessfulOutcome),
	offsetof(struct E1AP_UnsuccessfulOutcome, _asn_ctx),
	asn_MAP_E1AP_UnsuccessfulOutcome_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_E1AP_UnsuccessfulOutcome = {
	"UnsuccessfulOutcome",
	"UnsuccessfulOutcome",
	&asn_OP_SEQUENCE,
	asn_DEF_E1AP_UnsuccessfulOutcome_tags_1,
	sizeof(asn_DEF_E1AP_UnsuccessfulOutcome_tags_1)
		/sizeof(asn_DEF_E1AP_UnsuccessfulOutcome_tags_1[0]), /* 1 */
	asn_DEF_E1AP_UnsuccessfulOutcome_tags_1,	/* Same as above */
	sizeof(asn_DEF_E1AP_UnsuccessfulOutcome_tags_1)
		/sizeof(asn_DEF_E1AP_UnsuccessfulOutcome_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_E1AP_UnsuccessfulOutcome_1,
	3,	/* Elements count */
	&asn_SPC_E1AP_UnsuccessfulOutcome_specs_1	/* Additional specs */
};
